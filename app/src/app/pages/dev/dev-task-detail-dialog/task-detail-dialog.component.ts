...
@Component({
  ...
  providers: [DevTaskDetailService]
})
export class DevTaskDetailDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<DevTaskDetailDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: any,
              public fb: FormBuilder, private _service: DevTaskDetailService, private toasterService: ToasterService,
